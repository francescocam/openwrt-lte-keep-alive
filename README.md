...
2. Make sure the router is online, then **run the installer using this command** and follow the instructions:<br>
   `wget -q --no-check-certificate https://raw.githubusercontent.com/francescocam/openwrt-lte-keep-alive/refs/heads/master/install.sh -O install.sh && chmod +x install.sh && ./install.sh`
